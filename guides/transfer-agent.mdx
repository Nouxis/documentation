...
4. The new owner receives all future NouX settlement payments
...
<Steps>
  ...
  <Step title="Call claimAgent">
    ...
    import { claimAgent, getNetworkConfig } from "@Nouxis-ai/sdk";
  ...
  <Step title="Set up new delegations">
    ...
    ```typescript
    import { createDelegation, DelegationScope } from "@Nouxis-ai/sdk";
...
| Future NouX revenue | Previous owner's off-chain config access |
