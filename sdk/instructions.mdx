---
title: "Instructions"
description: "All instruction builders for the Nouxis program"
---

Every instruction builder in the SDK is an async function that takes a `program: NouxisProgram` as its first argument and returns an object containing the built `TransactionInstruction` along with any derived PDAs.
...
Set an NouX payment gate for a service. Each service type can have one payment requirement.
